...
sueldos_dolar <- kiwi21 %>% 
  filter(Trabajo !="Freelance", `País en el que trabajas` != "España") %>% 
...
La línea punteada indica el sueldo promedio en dólares en RRHH de toda la muestra de datos que es de `r emo::ji("dollar")` `r paste0("U$S ", round(mean(sueldos_dolar$sueldo_dolar)))`.
]
...
.pull-right[
En el único caso en que las mujeres tienen un sueldo promedio más alto que los hombres es en el puesto de *Analista* de acuerdo a la muestra recolectada por nuestra encuesta.
