...
Es este gráfico podemos apreciar cómo se distribuyen los resultados, y el cuadrado rojo indica el salario promedio en la región. 
<br>
```{r posiciones, out.width="45%", fig.align='center'}
